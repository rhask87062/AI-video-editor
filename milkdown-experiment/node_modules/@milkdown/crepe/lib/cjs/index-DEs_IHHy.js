  ...
  editor.config((ctx) => {
    ctx.update(tableBlock.tableBlockConfig.key, (defaultConfig) => ({
      ...
      renderButton: (renderType) => {
        ...
        switch (renderType) {
          case "add_row":
            return (_b = (_a = config == null ? void 0 : config.addRowIcon) == null ? void 0 : _a.call(config)) != null ? _b : plus.plusIcon;
          case "add_col":
            return (_d = (_c = config == null ? void 0 : config.addColIcon) == null ? void 0 : _c.call(config)) != null ? _d : plus.plusIcon;
          case "delete_row":
            return (_f = (_e = config == null ? void 0 : config.deleteRowIcon) == null ? void 0 : _e.call(config)) != null ? _f : remove.removeIcon;
          case "delete_col":
            return (_h = (_g = config == null ? void 0 : config.deleteColIcon) == null ? void 0 : _g.call(config)) != null ? _h : remove.removeIcon;
          case "align_col_left":
...
//# sourceMappingURL=index-DEs_IHHy.js.map
